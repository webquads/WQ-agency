...
const HeroText = () => {
  return (
    <div className="flex justify-center flex-col items-center gap-5 z-30">
      <h2 className="text-[clamp(2.5rem,5vw,12rem)] text-center font-bold  mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 via-yellow-600 to-orange-600 animate-textGradient bg-[length:200%_auto] leading-tight">
